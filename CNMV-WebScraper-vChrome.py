...
def load_sector(cadena):
    ...
    #driver = webdriver.Chrome(options=options, executable_path='./SeleniumDriver/ChromeDriver73.0.3683.68.exe')
    driver = webdriver.Chrome(options=options, executable_path='C:/Users/Marimar/Anaconda3/Lib/site-packages/selenium/webdriver/chrome/ChromeDriver73.0.3683.68.exe')
